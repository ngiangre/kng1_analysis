...
for i,features in enumerate(all_clin_1_and_prot_1):
        ...
        params.update({'X' : X.join(Y_pgd),'models' : models.copy()})
...
perf_df.to_csv(dir_+'mortality_predictions_'+type_+'_performance_survival_wpgdcov.csv')
...
fimps_df.to_csv(dir_+'mortality_predictions_'+type_+'_feature_importance_survival_wpgdcov.csv')

ppreds_df.to_csv(dir_+'mortality_predictions_'+type_+'_patient_predictions_survival_wpgdcov.csv')


pd.concat(fimps_dfs).to_csv(dir_+'mortality_predictions_'+type_+'_full_feature_importance_survival_wpgdcov.csv')
pd.concat(perm_fimps_dfs).to_csv(dir_+'mortality_predictions_'+type_+'_full_permuted_feature_importance_survival_wpgdcov.csv')
