...
for i,features in enumerate(all_clin_1_and_prot_1):
	...
	params.update({'X' : X.join(cov_df),'models' : models.copy()})
...
pd.concat(perm_fimps_dfs).to_csv(dir_+'mortality_predictions_'+type_+'_full_permuted_feature_importance_survival_wcovs.csv')
