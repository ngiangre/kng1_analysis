...
joined = pd.read_csv(dir_+'survival_X_y.csv',index_col=0)
...
perf_df.to_csv(dir_+'survival_predictions_'+type_+'_performance.csv')
...
fimps_df.to_csv(dir_+'survival_predictions_'+type_+'_feature_importance.csv')

ppreds_df.to_csv(dir_+'survival_predictions_'+type_+'_patient_predictions.csv')


pd.concat(fimps_dfs).to_csv(dir_+'survival_predictions_'+type_+'_full_feature_importance.csv')
pd.concat(perm_fimps_dfs).to_csv(dir_+'survival_predictions_'+type_+'_full_permuted_feature_importance.csv')
